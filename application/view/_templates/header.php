...
<html lang="en">
  <head>
    ...
    <!-- Meta -->
    <meta name="description" content="Proyecto SENA">
    ...
    <link href="<?= URL ?>lib/jquery-toggles/toggles-full.css" rel="stylesheet">
    <link href="<?= URL ?>lib/rickshaw/rickshaw.min.css" rel="stylesheet">

    <!-- Amanda CSS -->
    <link rel="stylesheet" href="<?= URL ?>css/amanda.css">
  </head>
        ...
        <div id="mainMenu" class="tab-pane active">
          <ul class="nav am-sideleft-menu">
            ...
            <li class="nav-item">
              ...
              <ul class="nav-sub">
                <li class="nav-item"><a href="<?= URL ?>persona" class="nav-link">Listar</a></li>
                <li class="nav-item"><a href="<?= URL ?>persona/crear" class="nav-link">Crear</a></li>
              </ul>
            </li><!-- nav-item -->
            <li class="nav-item">
              <a href="" class="nav-link with-sub">
